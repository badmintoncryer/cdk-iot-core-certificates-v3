...
| <code><a href="#cdk-iot-core-certificates-v3.ThingWithCert.with">with</a></code> | Applies one or more mixins to this construct. |
...
##### `with` <a name="with" id="cdk-iot-core-certificates-v3.ThingWithCert.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="cdk-iot-core-certificates-v3.ThingWithCert.with.parameter.mixins"></a>
